...
definir_mensagens() {
  case $idioma in
    1)
      ...
      msg_passo3="Passo 3: Baixando Stack Traefik:"
      ...
      msg_passo4="Passo 4: Atualizando Repositórios"
      msg_repo_ok="✅ Repositórios atualizados com sucesso."
      msg_repo_erro="❌ Erro ao atualizar repositórios."

      msg_passo5="Passo 5: Verificando Chave GPG do Docker"
      ...
      msg_passo6="Passo 6: Configurando Repositórios do Docker"
      ...
      msg_passo7="Passo 7: Instalando Docker"
      ...
      msg_passo8="Passo 8: Configurando Docker para iniciar automaticamente"
      ...
      msg_passo9="Passo 9: Obtendo IP da máquina"
      msg_obter_ip_erro="❌ Erro ao obter IP da máquina."
      msg_obter_ip_ok="✅ IP da máquina:"

      msg_passo10="Passo 10: Verificando Docker Swarm"
      ...
      msg_passo11="Passo 11: Verificando Rede 'network_swarm_public'"
      ...
      msg_passo12="Passo 12: Subindo Stack Traefik"
...
###########################################
# Passo 1: Solicitar o domínio ao usuário #
###########################################
print_with_line "$msg_passo1"

# Chamada da função
while true; do
  echo -e "$msg_solicita_dominio\n"
  read -p "> " DOMINIO
...
##########################################
# Passo 2: Solicitar o e-mail do usuário #
##########################################
...
#########################################
# Passo 5: Baixar e configurar o Docker #
#########################################
...
################################################
# Passo 6: Configurando Repositórios do Docker #
################################################
...
###########################################################
# Passo 8: Configurar Docker para iniciar automaticamente #
###########################################################
...
###########################################################
# Passo 10: Verificar se Docker Swarm já está inicializado #
###########################################################
...
####################################
# Passo 11: Verificar/criar a rede #
####################################
...
####################################
# Passo 12: Subir stack do Traefik #
####################################
print_with_line "$msg_passo12"
